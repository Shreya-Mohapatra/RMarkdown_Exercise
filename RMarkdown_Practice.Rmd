...
```{r GGANIMATE v2, fig.cap= "The DD animation #2 (coolest, in my humble opninion)"}
...
You can now also appreciate the difference between creating facets in a graph ( as [VERSION ONE](#version-one) ) for the different datasets vs overlaying the datasets ( as in [VERSION TWO](#version-two) ) in the graph.
