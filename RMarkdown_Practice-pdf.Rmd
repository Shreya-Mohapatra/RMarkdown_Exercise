...
```{r GGPLOT v1, fig.cap="The DD ggplot #1", fig.dim=c(5, 8), message=FALSE, warning=FALSE, fig.show='asis'}
...
```{GGANIMATE v1, fig.cap= "The DD animation #1"}
...
> view [here](https://github.com/Shreya-Mohapatra/RMarkdown_Exercise/blob/8f70dd72e46dd8b407e777ffe6a7101c7cc0c8fa/figs/simpleanimated.gif)
...
```{r GGPLOT v2, fig.cap= "The DD ggplot #2", fig.dim=c(5, 5), message=FALSE, warning=FALSE, fig.show='asis'}
...
```{GGANIMATE v2, fig.cap= "The DD animation #2 (coolest, in my humble opinion)"}
...
> view [here](https://github.com/Shreya-Mohapatra/RMarkdown_Exercise/blob/b81e8c4717299a1080e026dd4d34ecb75e970b9e/figs/notsosimpleanimated.gif)
...
- [Code chunk](https://rmarkdown.rstudio.com/lesson-3.html)
